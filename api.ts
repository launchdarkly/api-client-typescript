...
export class FeatureFlagsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public patchExpiringUserTargets (projectKey: string, environmentKey: string, featureFlagKey: string, patchComment: PatchComment, options: any = {}) : Promise<{ response: http.ClientResponse; body: UserTargetingExpirationForFlags;  }> {
        const localVarPath = this.basePath + '/flags/{projectKey}/{featureFlagKey}/expiring-user-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        ...
        if (patchComment === null || patchComment === undefined) {
            throw new Error('Required parameter patchComment was null or undefined when calling patchExpiringUserTargets.');
        }
...
export class UserSettingsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public patchExpiringUserTargetsForFlags (projectKey: string, environmentKey: string, userKey: string, patchComment: PatchComment, options: any = {}) : Promise<{ response: http.ClientResponse; body: UserTargetingExpirationOnFlagsForUser;  }> {
        const localVarPath = this.basePath + '/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'userKey' + '}', encodeURIComponent(String(userKey)));
        ...
        // verify required parameter 'patchComment' is not null or undefined
        if (patchComment === null || patchComment === undefined) {
            throw new Error('Required parameter patchComment was null or undefined when calling patchExpiringUserTargetsForFlags.');
        }
