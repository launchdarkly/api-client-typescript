...
export class FeatureFlagsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public getFeatureFlags (projectKey: string, env?: string, summary?: boolean, archived?: boolean, tag?: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlags;  }> {
