...
export class FeatureFlagStatus extends null<String, FeatureFlagStatusForQueriedEnvironment> {
    'links'?: Links;
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FeatureFlagStatus.attributeTypeMap);
    }
}
...
export class CustomRolesApi {
     ...
     */
    public postCustomRole (customRoleBody: CustomRoleBody) : Promise<{ response: http.ClientResponse; body: CustomRole;  }> {
        const localVarPath = this.basePath + '/roles';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
...
export class CustomerMetricsApi {
     ...
     */
    public getEvaluations (envId: string, flagKey: string) : Promise<{ response: http.ClientResponse; body: StreamSDKVersion;  }> {
     ...
     */
    public getEvent (type: string) : Promise<{ response: http.ClientResponse; body: StreamSDKVersion;  }> {
     ...
     */
    public getEvents () : Promise<{ response: http.ClientResponse; body: Events;  }> {
     ...
     */
    public getMAU () : Promise<{ response: http.ClientResponse; body: MAU;  }> {
     ...
     */
    public getMAUByCategory () : Promise<{ response: http.ClientResponse; body: MAUbyCategory;  }> {
     ...
     */
    public getStream (source: string) : Promise<{ response: http.ClientResponse; body: Stream;  }> {
     ...
     * @param source The source of where the stream comes from.
     */
    public getStreamBySDK (source: string) : Promise<{ response: http.ClientResponse; body: StreamBySDK;  }> {
     ...
     * @param source The source of where the stream comes from.
     */
    public getStreamSDKVersion (source: string) : Promise<{ response: http.ClientResponse; body: StreamSDKVersion;  }> {
     ...
     */
    public getStreams () : Promise<{ response: http.ClientResponse; body: Streams;  }> {
     ...
     */
    public getUsage () : Promise<{ response: http.ClientResponse; body: Usage;  }> {
...
export class DataExportDestinationsApi {
     ...
     */
    public deleteDestination (projectKey: string, environmentKey: string, destinationId: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
     ...
     * @param destinationId The data export destination ID.
     */
    public getDestination (projectKey: string, environmentKey: string, destinationId: string) : Promise<{ response: http.ClientResponse; body: Destination;  }> {
        const localVarPath = this.basePath + '/destinations/{projectKey}/{environmentKey}/{destinationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'destinationId' + '}', encodeURIComponent(String(destinationId)));
     ...
     */
    public getDestinations () : Promise<{ response: http.ClientResponse; body: Destinations;  }> {
     ...
     */
    public patchDestination (projectKey: string, environmentKey: string, destinationId: string, patchOnly: Array<PatchOperation>) : Promise<{ response: http.ClientResponse; body: Destination;  }> {
        const localVarPath = this.basePath + '/destinations/{projectKey}/{environmentKey}/{destinationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'destinationId' + '}', encodeURIComponent(String(destinationId)));
     ...
     */
    public postDestination (projectKey: string, environmentKey: string, destinationBody: DestinationBody) : Promise<{ response: http.ClientResponse; body: Destination;  }> {
...
export class EnvironmentsApi {
     ...
     */
    public postEnvironment (projectKey: string, environmentBody: EnvironmentPost) : Promise<{ response: http.ClientResponse; body: Environment;  }> {
...
export class FeatureFlagsApi {
     ...
     */
    public copyFeatureFlag (projectKey: string, featureFlagKey: string, featureFlagCopyBody: FeatureFlagCopyBody) : Promise<{ response: http.ClientResponse; body: FeatureFlag;  }> {
     ...
     * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
     */
    public getFeatureFlagStatusAcrossEnvironments (projectKey: string, featureFlagKey: string) : Promise<{ response: http.ClientResponse; body: FeatureFlagStatusAcrossEnvironments;  }> {
...
export class ProjectsApi {
     ...
     */
    public postProject (projectBody: ProjectBody) : Promise<{ response: http.ClientResponse; body: Project;  }> {
        const localVarPath = this.basePath + '/projects';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
...
export class TeamMembersApi {
     ...
     */
    public postMembers (membersBody: Array<MembersBody>) : Promise<{ response: http.ClientResponse; body: Members;  }> {
        const localVarPath = this.basePath + '/members';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
...
export class UserSegmentsApi {
     ...
     */
    public postUserSegment (projectKey: string, environmentKey: string, userSegmentBody: UserSegmentBody) : Promise<{ response: http.ClientResponse; body: UserSegment;  }> {
        const localVarPath = this.basePath + '/segments/{projectKey}/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
...
export class WebhooksApi {
     ...
     */
    public postWebhook (webhookBody: WebhookBody) : Promise<{ response: http.ClientResponse; body: Webhook;  }> {
        const localVarPath = this.basePath + '/webhooks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
