...
export class FeatureFlagsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteApprovalRequest (projectKey: string, environmentKey: string, featureFlagKey: string, approvalRequestId: string, approvalRequestConfigBody?: ApprovalRequestConfigBody, options: any = {}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public deleteFlagConfigScheduledChanges (projectKey: string, featureFlagKey: string, environmentKey: string, scheduledChangeId: string, options: any = {}) : Promise<{ response: http.ClientResponse; body?: any;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getApprovalRequest (projectKey: string, featureFlagKey: string, environmentKey: string, approvalRequestId: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: ApprovalRequests;  }> {
        const localVarPath = this.basePath + '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{approvalRequestId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
        ...
        return new Promise<{ response: http.ClientResponse; body: ApprovalRequests;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param {*} [options] Override http request options.
     */
    public getApprovalRequests (projectKey: string, featureFlagKey: string, environmentKey: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: ApprovalRequests;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public getFlagConfigScheduledChange (projectKey: string, featureFlagKey: string, environmentKey: string, scheduledChangeId: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChange;  }> {
        const localVarPath = this.basePath + '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{scheduledChangeId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
        ...
        return new Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChange;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param {*} [options] Override http request options.
     */
    public getFlagConfigScheduledChanges (projectKey: string, featureFlagKey: string, environmentKey: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChanges;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChanges;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param {*} [options] Override http request options.
     */
    public getFlagConfigScheduledChangesConflicts (projectKey: string, featureFlagKey: string, environmentKey: string, flagConfigScheduledChangesConflictsBody: FlagConfigScheduledChangesConflictsBody, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChangesConflicts;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChangesConflicts;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param {*} [options] Override http request options.
     */
    public patchFlagConfigScheduledChange (projectKey: string, featureFlagKey: string, flagConfigScheduledChangesPatchBody: FlagConfigScheduledChangesPatchBody, environmentKey: string, scheduledChangeId: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChange;  }> {
        const localVarPath = this.basePath + '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{scheduledChangeId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
     ...
     * @param {*} [options] Override http request options.
     */
    public postApplyApprovalRequest (projectKey: string, featureFlagKey: string, environmentKey: string, approvalRequestId: string, approvalRequestApplyConfigBody: ApprovalRequestApplyConfigBody, options: any = {}) : Promise<{ response: http.ClientResponse; body: ApprovalRequests;  }> {
     ...
     * @param {*} [options] Override http request options.
     */
    public postApprovalRequest (projectKey: string, featureFlagKey: string, environmentKey: string, approvalRequestId: string, approvalRequestConfigBody?: ApprovalRequestConfigBody, options: any = {}) : Promise<{ response: http.ClientResponse; body: ApprovalRequest;  }> {
        const localVarPath = this.basePath + '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{approvalRequestId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
        ...
        return new Promise<{ response: http.ClientResponse; body: ApprovalRequest;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param {*} [options] Override http request options.
     */
    public postFlagConfigScheduledChanges (projectKey: string, flagConfigScheduledChangesPostBody: FlagConfigScheduledChangesPostBody, featureFlagKey: string, environmentKey: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlagScheduledChange;  }> {
        const localVarPath = this.basePath + '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
     ...
     * @param {*} [options] Override http request options.
     */
    public postReviewApprovalRequest (projectKey: string, featureFlagKey: string, environmentKey: string, approvalRequestId: string, approvalRequestReviewConfigBody: ApprovalRequestReviewConfigBody, options: any = {}) : Promise<{ response: http.ClientResponse; body: ApprovalRequests;  }> {
