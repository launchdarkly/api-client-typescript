...
export class FeatureFlagsApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public getFeatureFlag (projectKey: string, featureFlagKey: string, env?: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlag;  }> {
        const localVarPath = this.basePath + '/flags/{projectKey}/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
     ...
     * @param {*} [options] Override http request options.
     */
    public getFeatureFlags (projectKey: string, env?: string, summary?: string, archived?: string, tag?: string, options: any = {}) : Promise<{ response: http.ClientResponse; body: FeatureFlags;  }> {
        ...
        if (summary !== undefined) {
            localVarQueryParameters['summary'] = ObjectSerializer.serialize(summary, "string");
        }

        if (archived !== undefined) {
            localVarQueryParameters['archived'] = ObjectSerializer.serialize(archived, "string");
        }
...
export class TeamMembersApi {
     ...
     * @param {*} [options] Override http request options.
     */
    public getMembers (options: any = {}) : Promise<{ response: http.ClientResponse; body: Members;  }> {
