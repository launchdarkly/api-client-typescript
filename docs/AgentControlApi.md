...
|[**deleteAgentOptimization**](#deleteagentoptimization) | **DELETE** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey} | Delete an agent optimization|
|[**deleteAgentOptimizationRun**](#deleteagentoptimizationrun) | **DELETE** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/runs/{runId} | Delete an agent optimization run|
...
|[**deletePromptSnippet**](#deletepromptsnippet) | **DELETE** /api/v2/projects/{projectKey}/ai-configs/prompt-snippets/{snippetKey} | Delete a prompt snippet|
...
|[**getAIConfigQuickStats**](#getaiconfigquickstats) | **GET** /api/v2/projects/{projectKey}/ai-configs/quick-stats | Get AI Config quick stats|
...
|[**getAgentOptimization**](#getagentoptimization) | **GET** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey} | Get an agent optimization|
|[**getModelConfig**](#getmodelconfig) | **GET** /api/v2/projects/{projectKey}/ai-configs/model-configs/{modelConfigKey} | Get AI model config|
|[**getPromptSnippet**](#getpromptsnippet) | **GET** /api/v2/projects/{projectKey}/ai-configs/prompt-snippets/{snippetKey} | Get a prompt snippet|
...
|[**listAgentOptimizationResults**](#listagentoptimizationresults) | **GET** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/results | List agent optimization runs|
|[**listAgentOptimizationResultsByRunId**](#listagentoptimizationresultsbyrunid) | **GET** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/runs/{runId}/results | List agent optimization results for a run|
|[**listAgentOptimizations**](#listagentoptimizations) | **GET** /api/v2/projects/{projectKey}/agent-optimizations | List agent optimizations|
|[**listAllAgentOptimizationResults**](#listallagentoptimizationresults) | **GET** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/all-results | List all agent optimization results across versions|
|[**listModelConfigs**](#listmodelconfigs) | **GET** /api/v2/projects/{projectKey}/ai-configs/model-configs | List AI model configs|
|[**listPromptSnippetReferences**](#listpromptsnippetreferences) | **GET** /api/v2/projects/{projectKey}/ai-configs/prompt-snippets/{snippetKey}/references | List prompt snippet references|
|[**listPromptSnippetVersions**](#listpromptsnippetversions) | **GET** /api/v2/projects/{projectKey}/ai-configs/prompt-snippets/{snippetKey}/versions | List prompt snippet versions|
|[**listPromptSnippets**](#listpromptsnippets) | **GET** /api/v2/projects/{projectKey}/ai-configs/prompt-snippets | List prompt snippets|
...
|[**patchAgentOptimization**](#patchagentoptimization) | **PATCH** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey} | Update an agent optimization|
|[**patchAgentOptimizationResult**](#patchagentoptimizationresult) | **PATCH** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/results/{resultId} | Update an agent optimization result|
|[**patchPromptSnippet**](#patchpromptsnippet) | **PATCH** /api/v2/projects/{projectKey}/ai-configs/prompt-snippets/{snippetKey} | Update a prompt snippet|
...
|[**postAgentOptimization**](#postagentoptimization) | **POST** /api/v2/projects/{projectKey}/agent-optimizations | Create agent optimization|
|[**postAgentOptimizationResult**](#postagentoptimizationresult) | **POST** /api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/results | Create agent optimization result|
|[**postModelConfig**](#postmodelconfig) | **POST** /api/v2/projects/{projectKey}/ai-configs/model-configs | Create an AI model config|
|[**postPromptSnippet**](#postpromptsnippet) | **POST** /api/v2/projects/{projectKey}/ai-configs/prompt-snippets | Create a prompt snippet|
...
const apiInstance = new AgentControlApi(configuration);
...
const { status, data } = await apiInstance.deleteAgentOptimization(
    projectKey,
    optimizationKey
);
```
...
const { status, data } = await apiInstance.deleteAgentOptimizationRun(
    lDAPIVersion,
    projectKey,
    optimizationKey,
    runId
...
let projectKey: string; // (default to undefined)
let snippetKey: string; // (default to undefined)

const { status, data } = await apiInstance.deletePromptSnippet(
    projectKey,
    snippetKey
);
```
...
|------------- | ------------- | ------------- | -------------|
| **projectKey** | [**string**] |  | defaults to undefined|
| **snippetKey** | [**string**] |  | defaults to undefined|
...
let contextKind: string; //A context kind. Only metrics from events that include a context of this kind are included. Required if `contextKey` is provided. (optional) (default to undefined)
let contextKey: string; //A context key. Only metrics from events whose context of the `contextKind` kind has this key are included. Requires `contextKind`. (optional) (default to undefined)
...
| **contextKind** | [**string**] | A context kind. Only metrics from events that include a context of this kind are included. Required if &#x60;contextKey&#x60; is provided. | (optional) defaults to undefined|
| **contextKey** | [**string**] | A context key. Only metrics from events whose context of the &#x60;contextKind&#x60; kind has this key are included. Requires &#x60;contextKind&#x60;. | (optional) defaults to undefined|
...
> QuickStats getAIConfigQuickStats()
...
const { status, data } = await apiInstance.getAIConfigQuickStats(
    projectKey,
    env
);
```
...
let projectKey: string; // (default to undefined)
let sort: string; //A sort to apply to the list of AgentControl configs. (optional) (default to undefined)
...
let filter: string; //A filter to apply to the list. (optional) (default to undefined)
...
|------------- | ------------- | ------------- | -------------|
| **projectKey** | [**string**] |  | defaults to undefined|
| **sort** | [**string**] | A sort to apply to the list of AgentControl configs. | (optional) defaults to undefined|
...
| **filter** | [**string**] | A filter to apply to the list. | (optional) defaults to undefined|
...
> AgentOptimization getAgentOptimization()
...
const { status, data } = await apiInstance.getAgentOptimization(
    projectKey,
    optimizationKey
);
```
...
const { status, data } = await apiInstance.getPromptSnippet(
    projectKey,
    snippetKey
);
```
...
> AgentOptimizationResults listAgentOptimizationResults()
...
const { status, data } = await apiInstance.listAgentOptimizationResults(
    projectKey,
    optimizationKey,
    limit,
    offset
...
> AgentOptimizationResults listAgentOptimizationResultsByRunId()
...
const { status, data } = await apiInstance.listAgentOptimizationResultsByRunId(
    projectKey,
    optimizationKey,
    runId
);
...
> AgentOptimizations listAgentOptimizations()
...
const { status, data } = await apiInstance.listAgentOptimizations(
    projectKey,
    limit,
    offset,
    filter
...
> AgentOptimizationResults listAllAgentOptimizationResults()
...
const { status, data } = await apiInstance.listAllAgentOptimizationResults(
    projectKey,
    optimizationKey,
    limit,
    offset
...
> SnippetReferences listPromptSnippetReferences()
...
const { status, data } = await apiInstance.listPromptSnippetReferences(
    projectKey,
    snippetKey,
    limit,
    offset
...
> PromptSnippets listPromptSnippetVersions()
...
const { status, data } = await apiInstance.listPromptSnippetVersions(
    projectKey,
    snippetKey,
    limit,
    offset
...
const { status, data } = await apiInstance.listPromptSnippets(
    projectKey,
    limit,
    offset,
    filter
...
> AgentOptimization patchAgentOptimization(agentOptimizationPatch)
...
let projectKey: string; // (default to undefined)
let optimizationKey: string; // (default to undefined)
let agentOptimizationPatch: AgentOptimizationPatch; //Agent optimization fields to update

const { status, data } = await apiInstance.patchAgentOptimization(
    projectKey,
    optimizationKey,
    agentOptimizationPatch
);
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **agentOptimizationPatch** | **AgentOptimizationPatch**| Agent optimization fields to update | |
| **projectKey** | [**string**] |  | defaults to undefined|
| **optimizationKey** | [**string**] |  | defaults to undefined|
...
> AgentOptimizationResult patchAgentOptimizationResult(agentOptimizationResultPatch)
...
let agentOptimizationResultPatch: AgentOptimizationResultPatch; //Agent optimization result fields to update

const { status, data } = await apiInstance.patchAgentOptimizationResult(
    projectKey,
    optimizationKey,
    resultId,
    agentOptimizationResultPatch
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **agentOptimizationResultPatch** | **AgentOptimizationResultPatch**| Agent optimization result fields to update | |
| **projectKey** | [**string**] |  | defaults to undefined|
| **optimizationKey** | [**string**] |  | defaults to undefined|
...
# **patchPromptSnippet**
> PromptSnippet patchPromptSnippet(promptSnippetPatch)
...
let projectKey: string; // (default to undefined)
let snippetKey: string; // (default to undefined)
let promptSnippetPatch: PromptSnippetPatch; //Prompt snippet fields to update

const { status, data } = await apiInstance.patchPromptSnippet(
    projectKey,
    snippetKey,
    promptSnippetPatch
);
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **promptSnippetPatch** | **PromptSnippetPatch**| Prompt snippet fields to update | |
| **projectKey** | [**string**] |  | defaults to undefined|
| **snippetKey** | [**string**] |  | defaults to undefined|
...
> AgentOptimization postAgentOptimization(agentOptimizationPost)
...
let projectKey: string; // (default to undefined)
let agentOptimizationPost: AgentOptimizationPost; //Agent optimization object to create

const { status, data } = await apiInstance.postAgentOptimization(
    projectKey,
    agentOptimizationPost
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **agentOptimizationPost** | **AgentOptimizationPost**| Agent optimization object to create | |
| **projectKey** | [**string**] |  | defaults to undefined|
...
> AgentOptimizationResult postAgentOptimizationResult(agentOptimizationResultPost)
...
let projectKey: string; // (default to undefined)
let optimizationKey: string; // (default to undefined)
let agentOptimizationResultPost: AgentOptimizationResultPost; //Agent optimization result to create

const { status, data } = await apiInstance.postAgentOptimizationResult(
    projectKey,
    optimizationKey,
    agentOptimizationResultPost
);
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **agentOptimizationResultPost** | **AgentOptimizationResultPost**| Agent optimization result to create | |
| **projectKey** | [**string**] |  | defaults to undefined|
| **optimizationKey** | [**string**] |  | defaults to undefined|
...
# **postPromptSnippet**
> PromptSnippet postPromptSnippet(promptSnippetPost)
...
let projectKey: string; // (default to undefined)
let promptSnippetPost: PromptSnippetPost; //Prompt snippet object to create

const { status, data } = await apiInstance.postPromptSnippet(
    projectKey,
    promptSnippetPost
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **promptSnippetPost** | **PromptSnippetPost**| Prompt snippet object to create | |
| **projectKey** | [**string**] |  | defaults to undefined|
